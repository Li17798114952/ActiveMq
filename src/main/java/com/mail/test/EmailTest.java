...
public class EmailTest {
    ...
    public void testSendAttachMail(){
        String[] to = {mailTo,"1309653176@qq.com"};
        mailService.sendAttachMail(to,"带附件的邮件","你好，这是一封带附件的邮件","D:\\1.png");
    }
    ...
    public void testSendInlineMail(){
        ...
        mailService.sendInlineMail(mailTo,"带静态图片的邮件",context,"D:\\1.png",resId);
    }
}
